        ...
        <SafeAreaView style={styles.container}>
            ...
            />
                    ...
                    <View style={{ marginBottom: responsiveHeight(1) }}>
                        <Text style={{ color: '#2D2D2D', fontFamily: 'Poppins-SemiBold', fontSize: responsiveFontSize(2.5), marginBottom: responsiveHeight(1) }}>Create New Password</Text>
                        <Text style={{ color: '#746868', fontFamily: 'Poppins-Regular', fontSize: responsiveFontSize(1.5), lineHeight: responsiveHeight(2.5) }}>Your new password must be different from previously used password</Text>
                    </View>
